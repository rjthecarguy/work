    ...
    <div class="grid grid-cols-1 md:grid-cols-4 gap-6">
        ...
        <section class="md:col-span-3">
            ...
            <div class="container mx-auto p-4">
                ...
                </div> <!-- End of Application submit -->
                @else
                <p class="my-5 bg-gray-300 p-3 rounded-lg">
                    <i class="fa fa-info-circle mr-3"></i> You must be logged in to submit an application.
                </p>
                @endauth
        ...
        <aside class="bg-white rounded-lg shadow-md p-3">
            ...
            @guest
                <p class="mt-10 bg-gray-200 text-gray-700 font-bold w-full py-2 px-4 rounded-full text-center">
                    <i class="fa fa-info-circle mr-3"></i>You must be logged in to bookmark a job </p>    
            @else
            ...
            <form
                 ...
                 ? route('bookmarks.destroy', $job->id) : route('bookmarks.store', $job->id) }}"
                  class="mt-10">
                @csrf
                ...
                @method('DELETE')
                <button class="bg-red-500 text white font-bold w-full py-2 px-4 rounded-full
                flex items-center justify-center hover:bg-red-600">
                <i class="fa fa-bookmark mr-3"></i>Delete Bookmark</button>
                                

                @else
                <button class="bg-blue-500 text white font-bold w-full py-2 px-4 rounded-full
                flex items-center justify-center hover:bg-blue-600">
               <i class="fa fa-bookmark mr-3"></i>Bookmark Listing</button>
